...
- `_steps-step-circle`: added at the start of the step when no steps-step-circle was written by hand.
- `_steps-step-line`: added at the start of the step when no steps-step-line was written by hand.
