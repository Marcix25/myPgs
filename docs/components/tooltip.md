...
- `mini`: applies the smallest button variant to the tooltip trigger.
...
<span pgs="dropdown tooltip">
    <button pgs="dropdown-button button['mini' 'iconOnly'] tooltip-button" title="open-tooltip" type="button">
