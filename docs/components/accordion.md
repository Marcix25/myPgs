...
<ul pgs="accordionContainer">
    ...
    <li pgs="accordion['autoOpen']">
        <button pgs="accordion-button" type="button">
            <span>Tempor incididunt (autoOpen)</span>
        </button>
