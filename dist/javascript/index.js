...
class PGS_Slides {
    ...
    #createButtonsAndDots() {
        ...
        if (!pgs(EL).querySelector('slides-prec')) {
            EL.insertAdjacentHTML("afterbegin", `<button pgs="slides-prec button" pgs-option="buttonIcon buttonMini" type="button" class="precButton" aria-label="slide precedente"> <span> <i pgs="icon rotate90" pgs-option="icon-chevronDown"></i></span></button>`);
        }
        if (!pgs(EL).querySelector('slides-next')) {
            EL.insertAdjacentHTML("beforeend", `<button pgs="slides-next button" pgs-option="buttonIcon buttonMini" type="button" class="nextButton" aria-label="prossima slide"> <span> <i pgs="icon rotate270" pgs-option="icon-chevronDown"></i></span></button>`);
        }
